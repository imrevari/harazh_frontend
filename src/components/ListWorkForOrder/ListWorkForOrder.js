        ...
        return (
            ...
            <tr>
                ...
                <button 
                    ...
                    style={((this.props.juser.role === 'ROLE_ADMIN') && !this.props.closed) ? (this.props.done ? {} : {display: 'none'}) : {display: 'none'}} 
                >Iзмiнити</button> </td>
                ...
                <td className="done" style={
                    ((this.props.juser.role === 'ROLE_ADMIN' || this.props.juser.role === 'ROLE_SENIOR_USER') && !this.props.closed) ? {} : {display: 'none'}
